...
import j1.s.p0011.DTO.ConvertSystem;
import j1.s.p0011.DTO.validateInput;
...
public class J1SP0011 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do
        {
            ...
            if (choiceFirst == 4) return;
            choiceThen = validateInput.inputInt("Enter your 2nd choice: ", 1, 4);
            if (choiceThen == 4) return;
            
            if (choiceFirst == choiceThen) System.out.println("Invalid choice. Re-enter.\n");
            else
            {
                switch (choiceFirst) {
                    case 1:
